            ...
            <div class="card">
                <Toolbar class="mb-4">
                    <template v-slot:start>
                        <div class="my-2">
                            <Button label="Hujjat qo'shish" icon="pi pi-plus" class="mr-2" severity="success"
                                @click="openNew" />
...
<DataTable ref="dt" :value="products" v-model:selection="selectedProducts" dataKey="id" :paginator="true" :rows="10"
    ...
    <template #header>
                        <div class="flex flex-column md:flex-row md:justify-content-between md:align-items-center">
                            <h5 class="m-0">Hujjatlarni boshqarish</h5>
    ...
    <Column field="code" header="JSHIR" :sortable="true" headerStyle="width:14%; min-width:10rem;">
        <template #body="slotProps">
                            <span class="p-column-title">JSHIR</span>
                            {{ slotProps.data.code }}
                        </template>
    </Column>
    <Column field="name" header="Familiya" :sortable="true" headerStyle="width:14%; min-width:10rem;">
        <template #body="slotProps">
                            <span class="p-column-title">Familiya</span>
                            {{ slotProps.data.name }}
                        </template>
    </Column>
    <Column field="category" header="Ism" :sortable="true" headerStyle="width:14%; min-width:10rem;">
        <template #body="slotProps">
                            <span class="p-column-title">Ism</span>
                            {{ slotProps.data.category }}
                        </template>
    </Column>
    <Column field="price" header="Lavozim" :sortable="true" headerStyle="width:14%; min-width:10rem;">
        <template #body="slotProps">
                            <span class="p-column-title">Lavozim</span>
                            {{ slotProps.data.category }}
                        </template>
    </Column>
    <Column field="inventoryStatus" header="Role" :sortable="true" headerStyle="width:10%; min-width:8rem;">
        <template #body="slotProps">
    ...
    <div class="formgrid grid">
        <div class="field col">
            ...
            <InputNumber id="price" v-model="product.price" mode="currency" currency="USD" locale="en-US"
                :invalid="submitted && !product.price" :required="true" />
